...
const CARD_TEMPLATES = [
    // ===== WARRIORS =====
    { name: 'Silver Knight',    cls: 'warrior',
    ...
    { name: 'Forest Warrior',   cls: 'warrior',
    ...
    { name: "Queen's Guard",    cls: 'warrior',
    ...
    // ===== ARCHERS =====
    { name: 'Shadow Stalker',   cls: 'archer',
    ...
    // ===== HEALERS =====
    { name: 'Golden Paladin',   cls: 'healer',
    ...
    { name: 'Dark Warlock',     cls: 'assassin',
