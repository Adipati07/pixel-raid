...
/* ========================================
 * MERGED from cards.js — Skill Card Data System (Sprint 1 cleanup)
 * ======================================== */
...
const SKILL_CARD_TEMPLATES = [
    { id: 'fireball', name: 'Fireball', type: 'attack', rarity: 'common', manaCost: 2, effect: { type: 'damage', value: 25, target: 'enemy' }, description: 'Deal 25 damage to enemy', pixelColor: '#ff4422' },
    { id: 'power_slash', name: 'Power Slash', type: 'attack', rarity: 'common', manaCost: 1, effect: { type: 'damage', value: 15, target: 'enemy' }, description: 'Deal 15 damage to enemy', pixelColor: '#ff6644' },
    ...
    { id: 'berserker_rage', name: 'Berserker', type: 'buff', rarity: 'epic', manaCost: 3, effect: { type: 'buff', stat: 'atk', value: 0.50, target: 'self', duration: 2 }, description: '+50% ATK for 2 turns', pixelColor: '#ff2244' },
    { id: 'weaken', name: 'Weaken', type: 'debuff', rarity: 'common', manaCost: 1, effect: { type: 'debuff', stat: 'atk', value: 0.20, target: 'enemy', duration: 2 }, description: 'Reduce enemy ATK by 20% for 2 turns', pixelColor: '#9b59b6' },
    { id: 'slow', name: 'Slow', type: 'debuff', rarity: 'common', manaCost: 1, effect: { type: 'debuff', stat: 'spd', value: 0.30, target: 'enemy', duration: 2 }, description: 'Reduce enemy SPD by 30% for 2 turns', pixelColor: '#8844cc' },
    { id: 'armor_break', name: 'Armor Break', type: 'debuff', rarity: 'rare', manaCost: 2, effect: { type: 'debuff', stat: 'def', value: 0.40, target: 'enemy', duration: 2 }, description: 'Reduce enemy DEF by 40% for 2 turns', pixelColor: '#cc4444' },
    { id: 'curse', name: 'Curse', type: 'debuff', rarity: 'epic', manaCost: 3, effect: { type: 'debuff', stat: 'all', value: 0.15, target: 'enemy', duration: 3 }, description: 'Reduce ALL enemy stats by 15% for 3 turns', pixelColor: '#6622aa' },
    { id: 'heal', name: 'Heal', type: 'special', rarity: 'common', manaCost: 2, effect: { type: 'heal', value: 30, target: 'self' }, description: 'Restore 30 HP', pixelColor: '#44ff88' },
    { id: 'life_drain', name: 'Life Drain', type: 'special', rarity: 'rare', manaCost: 3, effect: { type: 'lifesteal', value: 25, target: 'enemy' }, description: 'Deal 25 dmg and heal for the same amount', pixelColor: '#88ff44' },
    { id: 'mana_burst', name: 'Mana Burst', type: 'special', rarity: 'epic', manaCost: 0, effect: { type: 'mana_gain', value: 3, target: 'self' }, description: 'Gain 3 mana immediately (free to cast)', pixelColor: '#44aaff' },
];
